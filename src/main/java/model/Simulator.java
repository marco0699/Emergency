...
public class Simulator {
	...
	public void init() {
		...
		//inizializz modello del mondo
		this.patients = new ArrayList<>();
		this.waitingRoom = new PriorityQueue<>();
		this.freeStudios = this.totSudios; 
	...
	public int getFreeStudios() {
		return freeStudios;
	}

	public int getTotSudios() {
		return totSudios;
	}
	...
	public Duration getTIMEOUT_WHITE() {
		return TIMEOUT_WHITE;
	}

	public Duration getTIMEOUT_YELLOW() {
		return TIMEOUT_YELLOW;
	}

	public Duration getTIMEOUT_RED() {
		return TIMEOUT_RED;
	}
	...
	public void setTotSudios(int totSudios) {
		this.totSudios = totSudios;
	}
	...
	public void setPatientsAbandoned(int patientsAbandoned) {
		this.patientsAbandoned = patientsAbandoned;
	}

	public void setPatientDead(int patientDead) {
